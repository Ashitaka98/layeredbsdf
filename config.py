...
BASEINCLUDE    = ['#include', '/home/lzr/Tools/anaconda3/envs/layeredBsdf/include']
...
PNGLIB         = ['png']
JPEGLIB        = ['jpeg']
CNPYINCLUDE    = ['/home/lzr/Projects/cnpy/install/include']
CNPYLIBDIR     = ['/home/lzr/Projects/cnpy/install/lib']
CNPYLIB        = ['cnpy']
XERCESINCLUDE  = []
XERCESLIBDIR   = ['/home/lzr/Tools/anaconda3/envs/layeredBsdf/lib']
XERCESLIB      = ['xerces-c']
